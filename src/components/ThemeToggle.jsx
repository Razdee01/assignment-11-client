...
const ThemeToggle = () => {
  ...
  useEffect(() => {
    // Apply the theme to the data-theme attribute for DaisyUI
    document.documentElement.setAttribute("data-theme", theme);
    // Add/Remove 'dark' class for standard Tailwind dark: utilities
    if (theme === "night") {
  ...
  return (
    ...
    >
      ...
      <input type="checkbox" checked={theme === "night"} readOnly />
